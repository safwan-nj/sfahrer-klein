import './KassaList.css';
import  { useEffect, useState } from 'react';
import { useSelector } from 'react-redux';
import { selectKassaItems } from '../../Redux/kassasSlice';
...
function KassaList() {
  const invoicesData = useSelector(selectKassaItems); 
  ...
  return (
    <div className="app-container ">
      <div className="sa-bg-main-dark-transparent rounded-lg card-list-container">
